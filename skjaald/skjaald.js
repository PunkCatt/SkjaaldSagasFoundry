 ...
 * 
 * Author: PunkCat
 * Repository: https://github.com/PunkCatt/SkjaaldSagasFoundry
 * Issue Tracker: https://github.com/PunkCatt/SkjaaldSagasFoundry/issues
 */
...
Hooks.once("setup", function() {
  ...
  for ( let o of toLocalize ) {
    const localized = Object.entries(CONFIG.SKJAALD[o]).map(e => {
      return [e[0], game.i18n.localize(e[1])];
    });
    if ( !noSort.includes(o) ) localized.sort((a, b) => a[1].localeCompare(b[1]));
    CONFIG.SKJAALD[o] = localized.reduce((obj, e) => {
      obj[e[0]] = e[1];
      return obj;
    }, {});
  }
...
Hooks.once("ready", function() {
  ...
  const NEEDS_MIGRATION_VERSION = "0.0.2";
  const COMPATIBLE_MIGRATION_VERSION = 0.0;
