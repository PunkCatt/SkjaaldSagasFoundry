...
export default class ItemSheet5e extends ItemSheet {
  ...
  _onConfigureClassSkills(event) {
    ...
    const choices = skills.choices && skills.choices.length ? skills.choices : Object.keys(CONFIG.SKJAALD.skills);
    const a = event.currentTarget;
    ...
    new TraitSelector(this.item, {
      ...
      choices: Object.entries(CONFIG.SKJAALD.skills).reduce((obj, e) => {
