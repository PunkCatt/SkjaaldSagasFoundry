...
export default class ItemSheet5e extends ItemSheet {
  constructor(...args) {
    ...
    if ( this.object.data.type === "class" ) {
      this.options.width = this.position.width =  800;
      this.options.height = this.position.height = 1000;
    }
  }
  ...
  _onConfigureTraits(event) {
    ...
    switch(a.dataset.options) {
      ...
      case 'skills':
        ...
        const choiceSet = skills.choices && skills.choices.length ? skills.choices : Object.keys(CONFIG.SKJAALD.skills);
        options.choices = Object.fromEntries(Object.entries(CONFIG.SKJAALD.skills).filter(skill => choiceSet.includes(skill[0])));
