...
export default class ActorSheet5eCharacter extends ActorSheet5e {
  ...
  _prepareItems(data) {
    ...
    const features = {
      ...
      active: { label: "SKJAALD.FeatureActive", items: [], hasActions: true, dataset: {type: "feat", "activation.type": "action"} },
      passive: { label: "SKJAALD.FeaturePassive", items: [], hasActions: false, dataset: {type: "feat"} }
    };
    for ( let f of feats ) {
