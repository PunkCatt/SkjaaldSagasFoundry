...
export default class ActorSheet5e extends ActorSheet {
  ...
  _prepareTraits(traits) {
    const map = {
      ...
      "armorProf": CONFIG.SKJAALD.armorProficiencies,
      "weaponProf": CONFIG.SKJAALD.weaponProficiencies,
      "toolProf": CONFIG.SKJAALD.toolProficiencies
    };
  ...
  async _onDropActor(event, data) {
    const canPolymorph = game.user.isGM || (this.actor.owner && game.settings.get('skjaald', 'allowPolymorphing'));
  ...
  _onItemCreate(event) {
    ...
    const itemData = {
      name: game.i18n.format("SKJAALD.ItemNew", {type: type.capitalize()}),
      type: type,
